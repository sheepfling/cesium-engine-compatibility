# Cesium Unity Visual Proof Contract

This file records the repo-owned Windows visual-proof contract for the Unity
example project.
...
- Version-aware proof harness: `Assets/CesiumVisualProofCapture.cs`
...
- `artifacts/reports/cesium_visual_proof/unity/windows/x86_64/`

## Normalized Manifest

- `artifacts/reports/cesium_visual_proof/unity/windows/x86_64/visual_proof_manifest.json`
